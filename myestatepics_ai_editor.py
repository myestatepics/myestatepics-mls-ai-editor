"""
MyEstatePics MLS Interior Batch Editor — Direct V4.0.7
...
# stable so V4.0.6 reuses the established Direct Application Support settings.
DISPLAY_APPLICATION_NAME = "MyEstatePics AI Editor - Direct V4.0.7"
...
PROGRAM_VERSION = "4.0.7"
RELEASE_DATE = "2026-08-21"
PROMPT_VERSION = "V4.0.7"
MODEL = "gpt-image-2"
QUALITY = "medium"
...
def editing_agent() -> EditingAgent:
    """Return the zero-API V4.0.7 rule-memory layer using stable app support."""
...
def launch_gui() -> int:
    ...
    class EditingMemoryDialog(QDialog):
        ...
        def __init__(self, parent=None):
            super().__init__(parent)
            self.setWindowTitle("Editing Memory — MyEstatePics V4.0.7")
            self.resize(920, 480)
