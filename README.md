# MyEstatePics AI Editor — Direct V4.0.4
...
V4.0.4 production validation is governed by the
[regression manifest](docs/V4_0_4_REGRESSION_MANIFEST.md). It distinguishes
...
- Application badge: `Production v4.0.4` / `Prompt V4.0.4` (release date: `2026-08-20`)
...
1. Open `MyEstatePics AI Editor - Direct V4.0.4.dmg`.
2. Drag **MyEstatePics AI Editor - Direct V4.0.4** to **Applications**.
