# MyEstatePics AI Editor — Direct V4.0.7
...
V4.0.7 production validation is governed by the
[regression manifest](docs/V4_0_7_REGRESSION_MANIFEST.md). It distinguishes
...
- Application badge: `Production v4.0.7` / `Prompt V4.0.7` (release date: `2026-08-21`)
...
1. Open `MyEstatePics AI Editor - Direct V4.0.7.dmg`.
2. Drag **MyEstatePics AI Editor - Direct V4.0.7** to **Applications**.
