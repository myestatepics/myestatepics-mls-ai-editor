...
```text
MyEstatePics AI Editor - Direct V4.0.7.app
```
...
.venv/bin/python -m PyInstaller \
  ...
  --windowed \
  --onedir \
  --name "MyEstatePics AI Editor - Direct V4.0.7" \
...
```bash
PLIST="dist/MyEstatePics AI Editor - Direct V4.0.7.app/Contents/Info.plist"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleDisplayName MyEstatePics AI Editor - Direct V4.0.7" "$PLIST"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleName MyEstatePics AI Editor - Direct V4.0.7" "$PLIST"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleIdentifier com.myestatepics.aieditor.direct" "$PLIST"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleShortVersionString 4.0.7" "$PLIST"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleVersion 4.0.7" "$PLIST"
plutil -lint "$PLIST"
plutil -p "$PLIST"
```
...
| Field | Value |
| --- | --- |
| Display/name | `MyEstatePics AI Editor - Direct V4.0.7` |
...
```bash
test -f \
  "dist/MyEstatePics AI Editor - Direct V4.0.7.app/Contents/Resources/prompts/mls_production.txt"
cmp prompts/mls_production.txt \
  "dist/MyEstatePics AI Editor - Direct V4.0.7.app/Contents/Resources/prompts/mls_production.txt"
! find "dist/MyEstatePics AI Editor - Direct V4.0.7.app" -type f -name '.env' -print -quit \
  | grep -q .
```
...
codesign --force --deep --sign - \
  "dist/MyEstatePics AI Editor - Direct V4.0.7.app"
...
rm -rf build/dmg
mkdir -p build/dmg
ditto "dist/MyEstatePics AI Editor - Direct V4.0.7.app" \
  "build/dmg/MyEstatePics AI Editor - Direct V4.0.7.app"
ln -s /Applications build/dmg/Applications
rm -f "dist/MyEstatePics AI Editor - Direct V4.0.7.dmg"
hdiutil create \
  -volname "MyEstatePics AI Editor - Direct V4.0.7" \
  -srcfolder build/dmg \
  -ov \
  -format UDZO \
  "dist/MyEstatePics AI Editor - Direct V4.0.7.dmg"
```
...
```bash
open "dist/MyEstatePics AI Editor - Direct V4.0.7.app"
```
...
```bash
file \
  "dist/MyEstatePics AI Editor - Direct V4.0.7.app/Contents/MacOS/MyEstatePics AI Editor - Direct V4.0.7"
codesign --verify --deep --strict \
  "dist/MyEstatePics AI Editor - Direct V4.0.7.app"
hdiutil verify "dist/MyEstatePics AI Editor - Direct V4.0.7.dmg"
shasum -a 256 "dist/MyEstatePics AI Editor - Direct V4.0.7.dmg"
du -sh \
  "dist/MyEstatePics AI Editor - Direct V4.0.7.app" \
  "dist/MyEstatePics AI Editor - Direct V4.0.7.dmg"
```
...
├── MyEstatePics AI Editor - Direct V4.0.7.app/
└── MyEstatePics AI Editor - Direct V4.0.7.dmg
```
