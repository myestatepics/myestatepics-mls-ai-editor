...
```text
MyEstatePics AI Editor - Direct V4.0.1.app
```
...
.venv/bin/python -m PyInstaller \
  ...
  --windowed \
  --onedir \
  --name "MyEstatePics AI Editor - Direct V4.0.1" \
...
```bash
PLIST="dist/MyEstatePics AI Editor - Direct V4.0.1.app/Contents/Info.plist"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleDisplayName MyEstatePics AI Editor - Direct V4.0.1" "$PLIST"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleName MyEstatePics AI Editor - Direct V4.0.1" "$PLIST"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleIdentifier com.myestatepics.aieditor.direct" "$PLIST"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleShortVersionString 4.0.1" "$PLIST"
/usr/libexec/PlistBuddy -c \
  "Set :CFBundleVersion 4.0.1" "$PLIST"
plutil -lint "$PLIST"
plutil -p "$PLIST"
```
...
| Field | Value |
| --- | --- |
| Display/name | `MyEstatePics AI Editor - Direct V4.0.1` |
...
```bash
test -f \
  "dist/MyEstatePics AI Editor - Direct V4.0.1.app/Contents/Frameworks/prompts/mls_production.txt"
cmp prompts/mls_production.txt \
  "dist/MyEstatePics AI Editor - Direct V4.0.1.app/Contents/Frameworks/prompts/mls_production.txt"
! find "dist/MyEstatePics AI Editor - Direct V4.0.1.app" -type f -name '.env' -print -quit \
  | grep -q .
```
...
codesign --force --deep --sign - \
  "dist/MyEstatePics AI Editor - Direct V4.0.1.app"
...
rm -rf build/dmg
mkdir -p build/dmg
ditto "dist/MyEstatePics AI Editor - Direct V4.0.1.app" \
  "build/dmg/MyEstatePics AI Editor - Direct V4.0.1.app"
ln -s /Applications build/dmg/Applications
rm -f "dist/MyEstatePics AI Editor - Direct V4.0.1.dmg"
hdiutil create \
  -volname "MyEstatePics AI Editor - Direct V4.0.1" \
  -srcfolder build/dmg \
  -ov \
  -format UDZO \
  "dist/MyEstatePics AI Editor - Direct V4.0.1.dmg"
```
...
```bash
open "dist/MyEstatePics AI Editor - Direct V4.0.1.app"
```
...
```bash
file \
  "dist/MyEstatePics AI Editor - Direct V4.0.1.app/Contents/MacOS/MyEstatePics AI Editor - Direct V4.0.1"
codesign --verify --deep --strict \
  "dist/MyEstatePics AI Editor - Direct V4.0.1.app"
hdiutil verify "dist/MyEstatePics AI Editor - Direct V4.0.1.dmg"
shasum -a 256 "dist/MyEstatePics AI Editor - Direct V4.0.1.dmg"
du -sh \
  "dist/MyEstatePics AI Editor - Direct V4.0.1.app" \
  "dist/MyEstatePics AI Editor - Direct V4.0.1.dmg"
```
...
├── MyEstatePics AI Editor - Direct V4.0.1.app/
└── MyEstatePics AI Editor - Direct V4.0.1.dmg
```
